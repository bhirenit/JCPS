  ...
  <body>
    ...
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="customerDashboard.jsp">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Past History List</li>
            </ol>
        </nav>    
           ...
           <div class="container mt-5">
	   		<table id="data-table-simple-1" class="table">
			   	...
			   	<tbody style="font-size: 12px; text-align: center;">
			   		 ...
			   		 List<History> list = HistoryDao.getListByNumber(vehicle_number);
						...
						while (itr.hasNext())
						{
							...
							String link="pasthistoryview.jsp?id="+h.getHistoryId();
							%>
							<tr>
                            <td><%= Customername %></td>
                            <td><%= vehicleNumber %>
